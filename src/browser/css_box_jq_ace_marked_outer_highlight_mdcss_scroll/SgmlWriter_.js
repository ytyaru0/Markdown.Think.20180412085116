...
SgmlWriter.element = function(name, attrs=null, text=null, comment=null) {
...
// <name k="v" ... />
SgmlWriter.blank_element = function(name, attrs=null, comment=null) {
    return this._comment(comment) + '<' + name + this._attrs(attrs) + ' />';
}

// id="value" class="value" ...
SgmlWriter._attrs = function(attrs=null) {
